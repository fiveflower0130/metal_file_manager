...
關於這個專案的架構我當初構思的方向主要有兩個，一是"傳統全端架構"，二是"BaaS 整合架構"，但當我看到貴司有提到使用SupaBase的時候，我覺得後者會是一個更好的選擇，因為它可以讓我專注於前端開發，而不必過多關注後端的細節，當然最主要的原因是時間的關係，所以我選擇的較快的做法，不然我會常識兩個都做，所以還請多多包涵。
